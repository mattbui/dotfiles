# Generated by Powerlevel10k configuration wizard on 2020-09-28 at 15:42 +07.
...
() {
  ...
  # is empty.
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='${${${${CONDA_PROMPT_MODIFIER#\(}% }%\)}:-${CONDA_PREFIX:t}} py${P9K_ANACONDA_PYTHON_VERSION}'
