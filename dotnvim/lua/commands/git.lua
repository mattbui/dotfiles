...
vim.keymap.set("n", "<Leader>gS", "<Cmd>Gwrite<CR>", { silent = true, desc = "Stage current file" })
vim.keymap.set("n", "<Leader>gX", "<Cmd>Git reset %<CR>", { silent = true, desc = "Reset/undo current file" })
vim.keymap.set("n", "<Leader>gD", "<Cmd>Gvdiffsplit!<CR>", { silent = true, desc = "Diff current file" })
